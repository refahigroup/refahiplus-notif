...
public class PgNotifContext : DbContext, IDbContext
{

    public PgNotifContext(DbContextOptions<PgNotifContext> options)
       : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InboxMessage>()
                    .Property(p => p.ReadTime)
                    .HasColumnType("timestamp without time zone");

        modelBuilder.Entity<InboxMessage>()
                    .Property(p => p.DeliveredTime)
                    .HasColumnType("timestamp without time zone");
